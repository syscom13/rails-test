...
Product.create!(user: nicolas, name: "Stripe", url: "http://stripe.com",
...
Product.create!(user: nicolas, name: "Le Wagon", url: "http://lewagon.com",
                                 ...
                                 category: "education")
Product.create!(user: nicolas, name: "Hunter", url: "http://hunter.io",
                               tagline: "Find all the email addresses related to a domain",
                               category: "tech")
Product.create!(user: victor, name: "Station", url: "http://getstation.com",
